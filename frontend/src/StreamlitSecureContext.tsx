// Frontend entrypoint for Streamlit Secure Context Component
...
class StreamlitSecureContext extends StreamlitComponentBase {
  ...
  public render(): React.ReactNode {
    ...
    return <div ref={this.containerRef}>Initializing streamlit-secure-context...</div>;
  }
}

export default withStreamlitConnection(StreamlitSecureContext);