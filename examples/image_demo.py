...
st.title("🔒 Secure Image Classification Demo")
st.write("This demo classifies an image using a MobileNet model running entirely in the browser.")
...
secure_context(html_code, height=600)
"""Image Classification Demo using the streamlit-secure-context component.
...
# Embed the HTML snippet in a secure iframe
secure_context(
    html_code,
    height=600,
)
